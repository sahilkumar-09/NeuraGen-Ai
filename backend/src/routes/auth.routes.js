...
import { forgetPasswordValidator, loginValidator, registerValidator } from '../validator/auth.validator.js'
...
authRoutes.post("/user/reset-password/:token", resetPasswordController ,resetPasswordController)
